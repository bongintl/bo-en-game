    ...
    world => {
        ...
        var convertMetrics = parent => {
            ...
            parent.children.forEach( (child, i) => {
                ...
                child.attrs.x = (child.attrs.x / 100) * parent.attrs.width;
                child.attrs.y = (child.attrs.y / 100) * parent.attrs.height;
                
                //if( GL_TYPES.indexOf( child.type ) !== -1 ) {
                    
                    child.attrs.x -= parent.attrs.width / 2;
                    child.attrs.y -= parent.attrs.height / 2;
